...
```javascript
import complex from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assert, cast, parse, wrap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.0-esm/index.mjs';
