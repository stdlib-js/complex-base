...
```javascript
import complex from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assert, cast, parse, wrap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-esm/index.mjs';
...
[@stdlib/complex/base/assert]: https://github.com/stdlib-js/complex-base-assert/tree/esm

[@stdlib/complex/base/cast-return]: https://github.com/stdlib-js/complex-base-cast-return/tree/esm

[@stdlib/complex/base/parse]: https://github.com/stdlib-js/complex-base-parse/tree/esm
