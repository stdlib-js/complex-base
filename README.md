...
```javascript
import complex from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assert, cast, wrap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.2.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.2.1-esm/index.mjs';
