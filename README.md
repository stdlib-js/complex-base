...
```javascript
import complex from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assert, cast, parse, wrap } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base@v0.4.1-deno/mod.js';
...
[@stdlib/complex/base/assert]: https://github.com/stdlib-js/complex-base-assert/tree/deno

[@stdlib/complex/base/cast-return]: https://github.com/stdlib-js/complex-base-cast-return/tree/deno

[@stdlib/complex/base/parse]: https://github.com/stdlib-js/complex-base-parse/tree/deno
